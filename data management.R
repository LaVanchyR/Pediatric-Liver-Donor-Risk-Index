...
#date: 8/13/2026
#purpose: Manage data for the pediatric donor risk index project.
...
#create a growth failure variable
...
liver_cohort_clean <- liver_cohort_clean %>%
  select(-c(artificial_liver, donor_hist_mi, donor_intracranial_cancer, donor_dcd, donor_hist_cancer, donor_recov_out_us))
...
analysis3 <- data_imputed_1


#write out the analysis dataset
save(analysis3, file = "L:/Projects/Investigator/Jonathan Merola/data/analysis3.RData")